...
Hands-on creative technology experiences, selected from the full curriculum archive. Equipment and readiness labels are for internal deployment planning; partners pick the experience.

## Grades 3–7

### Build Your Block

Build a neighborhood invention for real people with cardboard, light, motion, sound, sensing, and one chosen coding platform.

**Formats:** course  
**Screen load:** S0–S2  
**Equipment:** E0→E2 — Cardboard and simple circuits at minimum; limited shared devices for one coding platform.  
**Documentation:** GO-P — Complete delivery package; choose the site platform and complete room/material preflight.  
**Source:** [`PRIMARY/Build_Your_Block`](../PRIMARY/Build_Your_Block)

## Grades 3–5

### From Idea to 3D Print

Draw, measure, model, slice, print, and revise a useful object for someone else.

**Formats:** course  
**Screen load:** S2  
**Equipment:** E3→E3 — Device pairs, Tinkercad, an operational FDM printer queue, and facilitator-managed print operations.  
**Documentation:** GO-P — Full plans, print operations, handouts, rubrics, and safety materials; validate accounts and printer workflow locally.  
**Source:** [`PRIMARY/3D-Printing-Course-3-5`](../PRIMARY/3D-Printing-Course-3-5)

### Scratch Stories and Games

Create an animated two-level Scratch game with cutscenes, playtesting, and a clear ending.

**Formats:** course  
**Screen load:** S3  
**Equipment:** E2→E2 — Shared or individual Scratch-capable devices and printable build handouts.  
...
Design, print, test, and redesign mechanisms that meet measurable performance targets.

**Formats:** course  
**Screen load:** S1–S2  
**Equipment:** E3→E3 — Reliable FDM printer workflow, shared test rigs, CAD devices, and prepared printed parts.  
**Documentation:** GO-P — Lessons, teacher guides, test rigs, rubrics, and templates are present; printer throughput is site-critical.  
**Source:** [`SECONDARY/Engineering-Challenges`](../SECONDARY/Engineering-Challenges)

### Design for Printability

Move from decorative CAD to fit gauges, tolerances, functional assemblies, and physical testing.

**Formats:** course  
**Screen load:** S2–S3  
**Equipment:** E3→E3 — CAD devices, FDM printers, slicer profiles, and printed test artifacts.  
**Documentation:** GO-P — Turnkey technical packet with day-zero checklist, A/B lessons, assessments, logs, and QA documentation.  
**Source:** [`SECONDARY/Design-for-Printability-and-Function`](../SECONDARY/Design-for-Printability-and-Function)

### Digital Imaging Lab

Use photography, pixels, layers, collage, glitch, and image ethics to make a small exhibition.

**Formats:** course  
**Screen load:** S3  
**Equipment:** E2→E2 — Devices, cameras or phones, headphones as needed, and a layer-based image editor.  
**Documentation:** GO — Complete 12-session sequence, project briefs, rubrics, software notes, and local setup fields.  
**Source:** [`SECONDARY/digital-imaging-lab`](../SECONDARY/digital-imaging-lab)

### Digital Manufacturing Studio

Translate designs into toolpaths for CNC and additive fabrication while learning safe machine workflows.

**Formats:** course  
**Screen load:** S2–S3  
**Equipment:** E3→E4 — CNC and/or additive fabrication equipment, CAM devices, safety infrastructure, and instructor-controlled production.  
**Documentation:** GO-P — Course modules, scripts, handouts, posters, G-code, and profiles are present; validate compatibility with the local machine fleet.  
**Source:** [`SECONDARY/digital_manufacturing`](../SECONDARY/digital_manufacturing)

### Robotics to FPV

Move from ground-robot control systems to simulator training, safe FPV flight, maintenance, and piloting.
...
Record, edit, synthesize, and mix sound through original Foley, stations, critique, and showcase work.

**Formats:** course  
**Screen load:** S2–S3  
**Equipment:** E2→E3 — Chromebooks or phones, headphones, recording/playback access, and a staged sound workspace.  
**Documentation:** GO-P — Complete 22-session package with daily plans, station cards, assessments, and troubleshooting; verify chosen audio platform.  
**Source:** [`SECONDARY/ExplorationSoundDesign`](../SECONDARY/ExplorationSoundDesign)
...
Design and build expressive Arduino-based MIDI controllers for sound, performance, and interaction.

**Formats:** course  
**Screen load:** S2–S3  
**Equipment:** E3→E3 — Arduino/MIDI kits, input components, computers, audio/MIDI hosts, and optional fabricated enclosures.  
**Documentation:** GO-P — Documented multi-level course family with hardware baseline and printables; pre-stage MIDI host setup and known-good firmware.  
**Source:** [`SECONDARY/Digital-Music-Control`](../SECONDARY/Digital-Music-Control)

### Physical Sound Drawing

Turn gesture, tension, and a single string into recordings, drawings, and a short performance piece.

**Formats:** course  
**Screen load:** S1–S3  
**Equipment:** E2→E3 — String rigs or alternate instruments, recording devices, a simple editing workflow, and a quiet-enough room.  
**Documentation:** GO — Syllabus, eight session plans, setup and file-management guidance, final brief, rubrics, and handouts are present.  
**Source:** [`SECONDARY/stringfield-studio-hs`](../SECONDARY/stringfield-studio-hs)

### Game Tech Intensive

Learn game logic with Scratch or physical computing with micro:bit through short, gentle technical studios.

**Formats:** course  
**Screen load:** S2–S3  
**Equipment:** E2→E3 — Scratch-capable devices for game design; micro:bits for physical-computing option.  
**Documentation:** GO — Exact six-session Scratch and micro:bit course packets include syllabi, Classroom posts, and grading documents.  
**Source:** [`SECONDARY/hs-game-tech-intro`](../SECONDARY/hs-game-tech-intro)

### AI in Your Feed: Create, Explore, Protect

Make and critique an AI-supported project while building habits around source checking, privacy, bias, consent, and refusal.
...
Collect a signal from a room, turn it into a postcard-sized data story, and make one recommendation for future users.

**Formats:** lunch lab  
**Screen load:** S1–S2  
**Equipment:** E2→E2 — Micro:bits, MakeCode-ready Chromebooks, printed maps, markers, and staged physical materials.  
**Documentation:** GO-P — Complete Lunch Lab package; verify micro:bit pairing and browser setup on site.  
**Source:** [`lunch-lab/LABS/01_signal_postcards`](../lunch-lab/LABS/01_signal_postcards)

### FPV Flight School

Practice calm simulator stick skills, recovery, and safe flight-system literacy with USB radios.

**Formats:** lunch lab  
**Screen load:** S3  
**Equipment:** E3→E3 — Simulator-ready laptops, USB radio controllers, a display, and prepared station rotation.  
**Documentation:** GO-P — Facilitator, participant, materials, and setup docs support station delivery; validate simulator installs and radio mapping.  
**Source:** [`lunch-lab/LABS/02_fpv_flight_school`](../lunch-lab/LABS/02_fpv_flight_school)

### Sound Logo Sprint

Build a five-to-ten second audio identity from Foley, rhythm, silence, and a simple editing workflow.

**Formats:** lunch lab  
**Screen load:** S1–S2  
**Equipment:** E1→E2 — Phones or Chromebooks, headphones, a Foley bin, one playback speaker, and a browser or DAW.  
**Documentation:** GO — Complete Lunch Lab documents, including explicit Foley guidance, shopping list, labels, and facilitator materials.  
**Source:** [`lunch-lab/LABS/03_sound_logo_sprint`](../lunch-lab/LABS/03_sound_logo_sprint)

### Robot Mood Machines

Remix a prebuilt LEGO SPIKE robot behavior to express a mood, service style, or personality.

**Formats:** lunch lab  
**Screen load:** S2  
**Equipment:** E2→E3 — LEGO SPIKE kits with prebuilt bases, working apps, mood cards, and a test mat.  
**Documentation:** GO-P — Delivery package is ready when bases, app versions, and test surface have been verified.  
**Source:** [`lunch-lab/LABS/04_robot_mood_machines`](../lunch-lab/LABS/04_robot_mood_machines)

### Dimension Token

Make a tiny dimension-controlled model, export an STL, and connect a live print to real production constraints.

**Formats:** lunch lab  
**Screen load:** S2–S3  
**Equipment:** E2→E3 — CAD devices, calipers, sample parts, a staged FDM printer, and facilitator-managed queue.  
**Documentation:** GO-P — Prepare templates and a known-good live print; participants need not operate the printer.  
**Source:** [`lunch-lab/LABS/05_dimension_token`](../lunch-lab/LABS/05_dimension_token)

### Tiny Code Creatures

Build a small micro:bit interaction that reacts to buttons, shake, or tilt, then give it a physical shell.

**Formats:** lunch lab  
**Screen load:** S2  
**Equipment:** E2→E2 — Micro:bits, MakeCode-ready Chromebooks, pre-tested starter programs, cardstock, and tape.  
**Documentation:** GO-P — Package is ready after devices and starter programs have been tested against the local browser environment.  
**Source:** [`lunch-lab/LABS/06_tiny_code_creatures`](../lunch-lab/LABS/06_tiny_code_creatures)

### AI Workflow Arcade

Trace a small AI-assisted workflow from sources through model output to verification and human approval.

**Formats:** lunch lab  
**Screen load:** S4  
**Equipment:** E2→E3 — Approved hosted AI interface, source packets, structured-output templates, and optional local-model demo.  
**Documentation:** GO-P — Strong documentation; every selected AI tool must receive host approval and event-day verification.  
**Source:** [`lunch-lab/LABS/07_ai_workflow_arcade`](../lunch-lab/LABS/07_ai_workflow_arcade)

### Own Your Own AI

Install and use a local language model while comparing local control, cloud convenience, and practical limits.
