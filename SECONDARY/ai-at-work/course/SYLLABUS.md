...
1. What is AI actually doing when it generates text or other outputs?
...
- a web browser
- shared cloud storage or LMS
- a word processor / docs platform
...
Assessment is competency-based and portfolio-driven.
...
- test tools rather than accept first drafts
...
Each student creates and presents a personal AI-at-work toolkit containing:
- a folder structure
- prompt notebook
- template pack
