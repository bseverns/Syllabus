# Session 01: Welcome to AI at Work + Microsoft Pathway
...
## Session focus
Students map where AI appears in daily and professional life, meet the course workflow, and see how the Microsoft Learn thread will run beside practical work.

## Learning targets
- Define the course question in plain language
- Identify where AI appears in real workplace tasks
- Set up folder structure and toolkit expectations

## Microsoft alignment
AI workloads and responsible use (orientation)
...
## Suggested artifact
- workspace folder + first glossary entries
