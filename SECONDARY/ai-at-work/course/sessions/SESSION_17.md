# Session 17: Simulation Studio I: IT / Admin / Operations Support
...
## Session focus
Students enter role-based simulations and use AI to support realistic task flows while tracking what still requires human judgment.

## Learning targets
- Complete a job-lane scenario task
- Document prompts, outputs, and corrections
- Name where escalation is necessary

## Microsoft alignment
AI workloads in operational practice
...
## Suggested artifact
- role-lane workflow packet start
