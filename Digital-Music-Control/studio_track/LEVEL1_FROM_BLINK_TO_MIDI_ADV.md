# Level 1: From Blink to MIDI — 4×2h (Studio Track (upper/advanced))
...
**Focus:** Foundations; fast feedback; mapping inputs to meaningful control; minimal blocking; serial discipline.
