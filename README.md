...
- [Energy-Electronics-and-Circuits](./PRIMARY/Energy-Electronics-and-Circuits) – Four-session Grades 3–5 low-voltage systems pilot; delivery review pending.
- [Machines-That-Move](./PRIMARY/Machines-That-Move) – Four-session Grades 3–5 mechanisms and automata pilot; delivery review pending.
- [Friendly-City-Lab](./PRIMARY/Friendly-City-Lab) – Four-session Grades 3–5 civic-design and wayfinding pilot; delivery review pending.
...
- [fpv-primer](./POST_SECONDARY/fpv-primer) – Five-session post-secondary FPV systems course that is complete at the props-off bench tier, with configuration proof, telemetry replay, mapping, maintenance, and stop-decision artifacts.
...
- [debugging](./SECONDARY/debugging) – Eight-session secondary debugging studio with device-free entry points, student process tools, facilitator recovery moves, and a portfolio-based finish.
- [sensing-and-gesture](./SECONDARY/sensing-and-gesture) – Fourteen-week college studio/seminar with low-tech through camera/sensor tiers, learner onboarding, materials, access/consent routines, and facilitator recovery paths.
...
- [choir-divider](./AE/choir-divider) – CMOS clock-divider pilot with corrected reset logic, per-pair kit quantities, learner onboarding, and a physical-verification facilitator checklist.
