# Week 05 — Tiny Museum Remix (Attribution)
**Time:** 90 min

### Goals
- Learn to responsibly remix CC-licensed models; add proper credit.
- Combine imported mesh with original Tinkercad geometry.
...
### Deliverables
- STL + **attribution note** pasted into `print-request-form.md`.
