...
- `SYLLABUS.md` — full course overview and weekly arc
- `curriculum/weeks/` — weekly plans with prep, adaptations, backup paths, and success indicators
- `facilitator/IMPLEMENTATION_NOTES.md` — room systems, prep rhythm, storage, repair, and showcase prep
- `facilitator/DIFFERENTIATION.md` — mixed-age design guidance
- `facilitator/STAFFING_AND_SCHEDULING.md` — staffing models and one-adult guidance
- `docs/ASSESSMENT_AND_DOCUMENTATION.md` — process-centered assessment and documentation options
- `docs/PARENT_FACING_DESCRIPTION.md` — public-facing language
- `docs/ONE_PAGER.md` — partner-ready summary
- `templates/` — capstone, status, showcase, and weekly planning templates
- `classhub_import/` — LMS-friendly import layer
