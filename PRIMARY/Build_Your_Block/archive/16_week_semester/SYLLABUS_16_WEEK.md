...
See `docs/ASSESSMENT_AND_DOCUMENTATION.md` for weekly look-fors and documentation modes.
...
See `docs/MATERIALS_AND_EQUIPMENT.md` for the full materials list.

For lower-resource sites, see `docs/MINIMUM_VIABLE_IMPLEMENTATION.md`. The course can still run well with cardboard, paper, tape, markers, LEDs, copper tape, coin cells, simple motors, and limited coding access.
