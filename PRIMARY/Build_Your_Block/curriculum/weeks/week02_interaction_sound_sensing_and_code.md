# Week 2: Interaction Lab, Sound, Sensing, Code, and Project Direction
...
## Weekly goals
- explore sound, sensing, and simple code as interaction tools
...
- one sensing pathway such as button, touch point, or simple sensor
- one coding platform only
- cardboard, labels, markers, tape
- project spark cards from Week 1

## Nice-to-have materials
- headphones or a quieter sound corner
- conductive materials
- screenshot templates or printed code cards
...
## Session 1
### Objective
Use sound to think about invitation, mood, and public interaction.
...
### Break / reset
Reset sound volume norms and rotate who is demoing.

### Build sprint 2
Students revise the interface so another person knows where to touch, press, or play.

### Share / document / park
Capture one short audio or video note and log how a user activates the build.

## Session 2
### Objective
Make input and output visible through sensing and reacting.
...
### Break / reset
Run a quick partner test and label touch or trigger points.

### Build sprint 2
Students improve the response so it is easier to read and explain.

### Share / document / park
Students make a quick arrow diagram showing what causes what.

## Session 3
### Objective
Introduce one coding pathway as another way to control visible behavior.
...
## Session 4
### Objective
Help students choose one likely project direction and one probable system path.

### Launch / prompt
Which project idea keeps pulling you back, and who is it for?

### Demo focus
Model a short project-direction conference: audience, purpose, likely systems, smallest first test.

### Build sprint 1
Students review Week 1 sparks plus Week 2 interaction experiments and shortlist one likely direction.

### Break / reset
Peer conference with warm/cool feedback.

### Build sprint 2
Students write or record one probable project direction and what system might make it possible.
...
One interaction record per student or team, one input/output or code map, and one likely project-direction statement.
...
- “This is for…”
- “When a visitor does this, the project…”
- “This tool fits our idea because…”
